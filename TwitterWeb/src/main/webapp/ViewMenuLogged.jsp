...
<div class="w3-bar w3-indigo  fixed-top">
	...
	<a class="users w3-bar-item w3-button w3-hide-small" id="Users" href=#> Explore Users </a>
...
<div id="stack" class="w3-bar-block w3-red w3-hide w3-hide-large w3-hide-medium">
	<a class="myTime w3-bar-item w3-button" id="GetOwnTimeline" href=#> My Timeline </a>
