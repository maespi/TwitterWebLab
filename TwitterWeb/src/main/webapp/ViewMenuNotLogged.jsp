...
<div class="w3-bar w3-indigo">
	...
	<a class="menu w3-bar-item w3-button w3-hide-small" id="AnonymousAccess" href=#> Anonymous Access </a> 
...
<div id="stack" class="w3-bar-block w3-indigo w3-hide w3-hide-large w3-hide-medium">
	...
	<a class="menu w3-bar-item w3-button " id="AnonymousAccess" href=#> Anonymous Access </a> 
